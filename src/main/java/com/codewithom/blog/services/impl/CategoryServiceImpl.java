...
import com.codewithom.blog.services.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
	...
	public CategoryDto getCategory(Integer categoryId) {
		Category cat=this.categoryRepo.findById(categoryId).orElseThrow(()->new ResourceNotFoundException("Category","ctegory id",categoryId));
